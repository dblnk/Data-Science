...
MAKE SURE TO SET THE EVAL ARGUMENT OF THE CHUNKS IN LINES 60 AND 162 TO TRUE, IF YOU HAVE NOT DOWNLOADED "edx.rds", "final_holdout_test.rds", "train.rds" and "test.rds" FILES INTO A data/ DIRECTORY AS CODED IN CHUNK IN LINE 19!!!

Make sure to have LaTeX 'float' and 'tinytex' packages installed when Knitting this document into pdf!
-->
...
grid.arrange(p1, p2, nrow =1) #%>% knitr::caption = "\\textit{Example of entries in the MovieLens database}"
...
```{r Movie-effect-Regul, fig.cap='Movie effect regularization',  out.height='30%', echo=FALSE, results='asis', warning=FALSE}
...
```{r User-behaviour, fig.cap='User activity vs. average user rating', fig.align='center',  out.width='60%', echo=FALSE, warning=FALSE, message=FALSE}
...
```{r User-effect-Regul, fig.cap='User effect regularization', fig.align='center',  out.height='30%',echo=FALSE, results='asis', warning=FALSE}
l <- seq(0, 10, 1)
...
```{r Year-effect, fig.cap='Year effect regularization', fig.align='center', out.height='30%', echo=FALSE, results='asis', message=FALSE, warning=FALSE}
...
```{r Genre-user-regul, fig.cap='Regularization of genre-user effects', fig.align='center', out.height='30%',echo=FALSE, message=FALSE, warning=FALSE}
